function updateColor(code) {
	...
	if (bodyPart == "head") {
			$.get("https://xdiscuss.net/func/character/postsColor.php?updateHead=" + code, function(data){
	...
	if (bodyPart == "leftarm") {
			$.get("https://xdiscuss.net/func/character/postsColor.php?updateLeftArm=" + code, function(data){
			$('#result').hide().html(data).fadeIn('slow');
			if (code == 1) {
	...
	if (bodyPart == "torso") {
			$.get("https://xdiscuss.net/func/character/postsColor.php?updateTorso=" + code, function(data){
			$('#result').hide().html(data).fadeIn('slow');
			if (code == 1) {
	...
	if (bodyPart == "rightarm") {
			$.get("https://xdiscuss.net/func/character/postsColor.php?updateRightArm=" + code, function(data){
			$('#result').hide().html(data).fadeIn('slow');
			if (code == 1) {
	...
	if (bodyPart == "leftleg") {
			$.get("https://xdiscuss.net/func/character/postsColor.php?updateLeftLeg=" + code, function(data){
			$('#result').hide().html(data).fadeIn('slow');
			if (code == 1) {
	...
	if (bodyPart == "rightleg") {
			$.get("https://xdiscuss.net/func/character/postsColor.php?updateRightLeg=" + code, function(data){
			$('#result').hide().html(data).fadeIn('slow');
			if (code == 1) {
